...
use smartdns_plus_ui::data_server::DataServer;
use smartdns_plus_ui::db::*;
use smartdns_plus_ui::dns_log;
use smartdns_plus_ui::plugin::*;
use smartdns_plus_ui::smartdns::*;
use std::io::Write;
use std::sync::Arc;
...
impl TestSmartDnsServer {
    ...
    pub fn start(&mut self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        let t = std::thread::spawn(move || {
            ...
            smartdns_plus_ui::smartdns::smartdns_server_run(&conf_file).unwrap();
    ...
    pub fn stop(&mut self) {
        ...
        smartdns_plus_ui::smartdns::smartdns_server_stop();
...
impl TestServer {
    pub fn new() -> Self {
        let mut server = TestServer {
            ...
            args: Vec::new(),
            workdir: String::new(),
            temp_dir: TempDir::with_prefix("smartdns-plus-ui-").unwrap(),
            www_root: String::new(),
            is_started: false,
    ...
    fn setup_default_args(&mut self) {
        ...
        self.args.insert(0, "smartdns-plus-ui".to_string());
    ...
    pub fn new_mock_domain_record(&self) -> DomainData {
        DomainData {
            id: 0,
            timestamp: smartdns_plus_ui::smartdns::get_utc_time_ms(),
    ...
    fn init_server(&mut self) -> Result<(), Box<dyn std::error::Error>> {
        ...
        self.old_log_level = smartdns_plus_ui::smartdns::dns_log_get_level();
        smartdns_plus_ui::smartdns::dns_log_set_level(self.log_level);
    ...
    pub fn stop(&mut self) {
        ...
        smartdns_plus_ui::smartdns::dns_log_set_level(self.old_log_level);
